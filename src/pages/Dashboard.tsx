    ...
    <Card className="rounded-xl shadow-sm hover:shadow-md transition-shadow">
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <div className="flex flex-col">
          ...
          {isMobile && tooltipContent && (
            <p className="text-xs text-gray-400 mt-1">{tooltipContent}</p>
          )}
        </div>
    ...
    <div className="p-4 md:p-8 space-y-8"> {/* Ajuste de padding para mobile */}
      ...
      <div className="grid gap-4 grid-cols-1 md:grid-cols-2 lg:grid-cols-4">
        ...
        <DashboardCard 
          ...
          isLoading={isLoadingMetrics}
          tooltipContent="Número total de pedidos registrados no sistema com status 'Reservado'."
        />
        <DashboardCard 
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <TaskListCard
          ...
          tooltipContent="Clientes agendados para retirar equipamentos hoje. Clique para ver detalhes e registrar a retirada."
        />
      </div>
      ...
      <div className="grid gap-6 md:grid-cols-2">
        <TaskListCard
          ...
          tooltipContent="Clientes agendados para devolver equipamentos hoje. Clique para ver detalhes e registrar a devolução."
        />
      </div>
    </div>
  );
